...
function createData(name: string, email: string, address: string, zipCode: string, street: string,): Data {
  return {
    name,
    email,
    address,
...
export function RestaurantPage() {
  ...
  useEffect(() => {
    restaurantService.getRestaurantsList().then((list) => {
      setList(list)
    })
  }, [])

  const rows = [
    createData('Cupcake', "305", "3.7", "67", "4.9")
  ];
